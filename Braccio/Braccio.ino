...
void otto() {
	angle += map(analogRead(A0) - analogRead(A1), -1023, 1023, -10, 10); // Compare value of the phototransistor on the vertical axis and convert to angle value
	m1 += map(analogRead(A2) - analogRead(A3), -1023, 1023, -10, 10);	// Compare value of the phototransistor on the horizontal axis and convert to angle value
